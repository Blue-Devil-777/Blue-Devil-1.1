...
os.system('xdg-open https://www.facebook.com/Foysal.Chowdhury.444')
...
╚═════╝░╚══════╝░░░╚═╝░░░╚═╝╚══════╝            \033[1;37m                     
----------------------------------------------
AUTHER    :  FOYSAL CHOWDHURY
TEAM :  ISLAM-TEAM
Facebook : Foysal Chowdhury
...
def Main_ZIDI():
        ...
        if shm =='1':
            ...
            os.system(f'xdg-open https://tinyurl.com/mrxw8ya7')
            Main_ZIDI()
        elif shm =='5':
            os.system('xdg-open https://www.facebook.com/Foysal.Chowdhury.444')
            Main_ZIDI()
